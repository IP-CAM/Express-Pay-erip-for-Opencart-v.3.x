...
$_['text_erip_expresspay']  = '<a target="_blank" href="https://express-pay.by/extensions/opencart-3-x/erip">
                            <img src="view/image/payment/erip_expresspay.png" alt="Сайт Express-pay" title="Сайт Express-pay"/></a>';
...
$_['namePaymentMethodDefault']          = 'Экспресс платежи: ЕРИП';
$_['tokenLabel']                        = 'Токен';
...
// Setting ERIP
$_['pathInEripLabel']           = 'Путь к ЕРИП';
$_['pathInEripTooltip']         = 'Путь по веткам ЕРИП для осуществления оплаты';
