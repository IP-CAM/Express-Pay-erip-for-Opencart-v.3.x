...
class ControllerExtensionPaymentEripExpressPay extends Controller{
    ...
    public function success()
    {
        ...
        if ($this->config->get(self::IS_SHOW_QR_CODE_PARAM_NAME)  == 'on' && isset($this->request->get['ExpressPayInvoiceNo'])) {
            ...
            try {
                $qrbase64json = $this->model_extension_payment_erip_expresspay->getQrbase64($invoiceNo, $this->config);
                ...
                $this->model_extension_payment_erip_expresspay_log->log_error_exception('success', 'Get response; INVOICE ID - ' . $invoiceNo. '; RESPONSE - ' . $qrbase64json, $e);
            }
        }
