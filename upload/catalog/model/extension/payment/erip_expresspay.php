...
class ModelExtensionPaymentEripExpressPay extends Model{
    ...
    public function setParams($data, $config)
    {
        ...
        $signatureParams['ReturnUrl'] = $this->url->link('extension/payment/erip_expresspay/success');
        $signatureParams['FailUrl'] = $this->url->link('extension/payment/erip_expresspay/fail');
