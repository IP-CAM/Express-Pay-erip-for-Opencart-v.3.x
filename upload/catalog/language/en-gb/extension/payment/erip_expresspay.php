<?php
// Heading
$_['heading_title']         = 'Express payments: ERIP';
$_['heading_title_success'] = 'An invoice was added for payment via the ERIP system';
$_['heading_title_fail']    = 'Billing error for payment via ERIP system';
...
'<br> 2. Next, enter the order number <b>##order_id##</b> and press "Continue"'.
...
$_['erip_path']         = 'Online stores/services->Services->First letter of online store domain name->Order domain name->Pay order';
